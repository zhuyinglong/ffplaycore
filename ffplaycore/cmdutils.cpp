...
void show_help_children(const AVClass *c, int flags)
{
    const AVClass *child = NULL;
    if (c->option) {
        av_opt_show2(&c, NULL, flags, 0);
        printf("\n");
    }
                         ...
                         const char *arg)
{
    ...
    OptionGroup *g;
	l->groups = (OptionGroup *)grow_array((void*)l->groups, sizeof(*l->groups), &l->nb_groups, l->nb_groups + 1);
                    ...
                    const char *key, const char *val)
{
	...
	g->opts = (Option *)grow_array((void*)g->opts, sizeof(*g->opts), &g->nb_opts, g->nb_opts + 1);
